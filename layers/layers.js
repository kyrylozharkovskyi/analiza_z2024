...
var format_Historycznatopo1940_4 = new ol.format.GeoJSON();
var features_Historycznatopo1940_4 = format_Historycznatopo1940_4.readFeatures(json_Historycznatopo1940_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Historycznatopo1940_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Historycznatopo1940_4.addFeatures(features_Historycznatopo1940_4);
var lyr_Historycznatopo1940_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Historycznatopo1940_4, 
                style: style_Historycznatopo1940_4,
                popuplayertitle: 'Historyczna topo 1940',
                interactive: false,
                title: '<img src="styles/legend/Historycznatopo1940_4.png" /> Historyczna topo 1940'
            });
var format_AnalizaHistzSantinel_5 = new ol.format.GeoJSON();
var features_AnalizaHistzSantinel_5 = format_AnalizaHistzSantinel_5.readFeatures(json_AnalizaHistzSantinel_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AnalizaHistzSantinel_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AnalizaHistzSantinel_5.addFeatures(features_AnalizaHistzSantinel_5);
var lyr_AnalizaHistzSantinel_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AnalizaHistzSantinel_5, 
                style: style_AnalizaHistzSantinel_5,
                popuplayertitle: 'Analiza Hist z Santinel',
                interactive: false,
    title: 'Analiza Hist z Santinel<br />\
    <img src="styles/legend/AnalizaHistzSantinel_5_0.png" /> -100 - -72<br />\
    <img src="styles/legend/AnalizaHistzSantinel_5_1.png" /> -72 - -38<br />\
    <img src="styles/legend/AnalizaHistzSantinel_5_2.png" /> -38 - -12<br />\
    <img src="styles/legend/AnalizaHistzSantinel_5_3.png" /> -12 - 19<br />\
    <img src="styles/legend/AnalizaHistzSantinel_5_4.png" /> 19 - 63<br />\
...
lyr_AnalizaHistzSantinel_5.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'GRID_ID': 'GRID_ID', 'proc_A': 'proc_A', 'proc_B': 'proc_B', 'proc_C': 'proc_C', 'roznica_A_': 'roznica_A_', 'roznica_B_': 'roznica_B_', });
...
lyr_Historycznatopo1940_4.set('fieldImages', {'Id': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'Field': 'TextEdit', 'pow': 'TextEdit', 'obw': 'TextEdit', 'wsp_zw': 'TextEdit', 'Field1': 'TextEdit', });
lyr_AnalizaHistzSantinel_5.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'GRID_ID': 'TextEdit', 'proc_A': 'TextEdit', 'proc_B': 'TextEdit', 'proc_C': 'TextEdit', 'roznica_A_': 'TextEdit', 'roznica_B_': 'TextEdit', });
...
lyr_Historycznatopo1940_4.set('fieldLabels', {'Id': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'Field': 'no label', 'pow': 'no label', 'obw': 'no label', 'wsp_zw': 'no label', 'Field1': 'no label', });
lyr_AnalizaHistzSantinel_5.set('fieldLabels', {'Shape_Leng': 'hidden field', 'Shape_Area': 'no label', 'GRID_ID': 'no label', 'proc_A': 'no label', 'proc_B': 'no label', 'proc_C': 'no label', 'roznica_A_': 'no label', 'roznica_B_': 'hidden field', });
lyr_AnalizaHistzSantinel_5.on('precompose', function(evt) {
